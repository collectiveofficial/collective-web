        ...
        <div className={s.rooter}>
          ...
          <div className={s.card}>
            ...
            <div className={s.infoCont}>
              <div className={s.info}>We believe that the food system is too big, too inefficient, and too unsustainable to feed people in the way they want. So we help to easily connect independent groups to local sources, allowing consumers to empower themselves through high quality, cheap produce. By cutting out the middleman and getting back to the community, we can provide farmer's market quality at convenience store price. You just buy into our $6 or $11 packages, and we help to give you a box full of amazing food.</div>
